...
const ContactPage = ({ data: { datoCmsContact } }) => (
  ...
  >
    ...
    <StyledWrapper>
      <StyledIframe
        src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBf_iOF4deZEAmUBiRmCn2eEVg1xm_BUtg&q=Zygmunta+Modzelewskiego+63%2Fu5,Warszawa+Polska&center=52.189796,21.015067"
        allowfullscreen
      />
